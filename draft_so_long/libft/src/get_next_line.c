...
/*   Updated: 2023/03/14 16:31:16 by wmillett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	t_var.tmp = ft_calloc(BUFFER_SIZE + 1, sizeof(char));
	t_var.rv = 0;
	...
	return (ft_sfree(t_var.tmp2), t_var.tmp);
}
